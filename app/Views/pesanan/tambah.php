...
<script>
  ...
  document.addEventListener('alpine:init', () => {
    ...
    // window.storeForm = Alpine.store('form');
    // window.storePembayaran = Alpine.store('pembayaran');
    // window.storeState = Alpine.store('state');
    // window.storeValidasi = Alpine.store('validasi');
    // window.storePesananMasuk = Alpine.store('pesananMasuk');
  })
