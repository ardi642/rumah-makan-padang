...
<form method="post" class="container mt-4 p-5 border border-1 rounded" id="form" class="was-validated" x-data>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="username" placeholder="masukkan password lama" :value="$store.form.password_lama" x-model="$store.form.password_lama" @keyup="resetValidasi('password_lama')">
  ...
  <template x-if="$store.form.password_lama != '' && $store.form.password_lama != null">
    <div>
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="username" placeholder="masukkan password baru" :value="$store.form.password_baru" x-model="$store.form.password_baru" @keyup="resetValidasi('password_baru')">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="username" placeholder="konfirmasi password baru" :value="$store.form.konfirmasi_password" x-model="$store.form.konfirmasi_password" @keyup="resetValidasi('konfirmasi_password')">
